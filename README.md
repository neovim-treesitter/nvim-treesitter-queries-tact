# nvim-treesitter-queries-tact

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-tact/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-tact/actions/workflows/validate.yml)

Neovim tree-sitter queries for **tact**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-tact",
...
- [ ] Changes are scoped to `tact` — do not include files for other languages
